...
5. Отказ по правилу 2 — только если ни один фрагмент не отвечает на
   вопрос ни прямо, ни косвенно. Другая падежная форма имени/прозвища
   («хромоножке» вместо «Хромоножка») или переформулировка
   («так называли X» как ответ на «кто такой X») — это ответ, а не
   повод отказаться."""
