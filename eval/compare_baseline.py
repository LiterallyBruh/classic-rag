"""Сравнение с baseline: чистый LLM (без RAG) против ClassicRAG.
...
- refused: система честно отказалась (только ClassicRAG: baseline
...
def write_report(rows: list, out: Path, model: str) -> None:
    ...
    lines = [
        "# Baseline (LLM без RAG) vs ClassicRAG",
        "",
        ...
        "школьник не может. ClassicRAG цитирует дословно, адресует верно,",
        ...
        "",
        "| Метрика | LLM без RAG | ClassicRAG |",
        "|---|---|---|",
