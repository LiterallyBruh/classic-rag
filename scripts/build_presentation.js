...
(async () => {
  ...
  s.addText([
    { text: "Верных по сути ответов почти поровну: 10 и 11 из 29. Но baseline подкрепляет выдуманной цитатой и верные ответы, и неверные — отличить их нельзя. ", options: {} },
    { text: "У RAG цитату и адрес можно проверить, а без опоры — честный отказ.", options: { bold: true, color: BERRY } },
  ], { x: 0.7, y: 4.64, w: 8.6, h: 0.68, fontSize: 11.5, color: INK, align: "center", valign: "middle", margin: 0 });
